					...
					<table class="TableStyle">
						...
						<tr>
							...
							<td colspan=3><input type="checkbox" name="interest"
								...
								value="문화">문화 <br><input type="checkbox" name="interest"
								value="역사">역사 <input type="checkbox" name="interest"
								value="연예">연예 <input type="checkbox" name="interest"
								value="스포츠">스포츠 <input type="checkbox" name="interest"
								value="예술">예술<br></td>
						</tr>
						<tr>
